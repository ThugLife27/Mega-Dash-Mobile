...
autoRefreshLeaderboardsAmount = 1000;
...
if(asyncStatus == 0)
{
    ...
    else if(global.LootLockerInitialized == true)
    {
		...
		{
			global.LootLockerHighscoresTopRankList = array_create(1000, " ");
			global.LootLockerHighscoresTopNamesList = array_create(1000, " ");
			global.LootLockerHighscoresTopMetadataList = array_create(1000, " ");
			global.LootLockerHighscoresTopScoreList = array_create(1000, " ");
			global.LootLockerHighscoresTopIDList = array_create(1000, " ");
		...
		{
			// Second call
			global.LootLockerHighscoresCenteredRankList = array_create(1000, " ");
			global.LootLockerHighscoresCenteredNamesList = array_create(1000, " ");
			global.LootLockerHighscoresCenteredMetadataList = array_create(1000, " ");
			global.LootLockerHighscoresCenteredScoreList = array_create(1000, " ");
			global.LootLockerHighscoresCenteredIDList = array_create(1000, " ");
