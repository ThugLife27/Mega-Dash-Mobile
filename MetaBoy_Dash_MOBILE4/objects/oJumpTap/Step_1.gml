...
JumpTapStart = MultiTouchCheckPressed();
JumpTap = MultiTouchCheck();
...
if(global.controlsetting == 1)
{
	if(instance_exists(oUltButton))
	{
		with(oUltButton)
		{
			...
			if(UltTap == 1){oJumpTap.JumpTapStart = 0;}
		}
	}
	...
	if(instance_exists(oTimeDistortButton))
	{
		with(oTimeDistortButton)
		{
			...
			if(TDTap == 1){oJumpTap.JumpTapStart = 0;}
		}
	}
	...
	if(instance_exists(oGhostButton))
	{
		with(oGhostButton)
		{
			...
			if(GhostTap == 1){oJumpTap.JumpTapStart = 0;}
		}
	}
}
