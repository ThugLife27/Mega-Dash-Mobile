...
{
if (enemy_dead == 0 && global.dash_mode == 1 && oPlayerTutorial.hsp >= 0)
{
	...
	else
	{
			...
			if(oGaiaTextBox.level == 3 && 100*global.multiplier == 1000)
			{
				oGaiaTextBox.level++;
...
if (enemy_dead == 0 && (global.dash_mode == 0 || oPlayerTutorial.hsp < 0) && global.GhostActive == 0 && global.uNimbleFighter == 0 && global.player_revive_mode == 0 && global.uSuperman == 0 && global.SS4SuperSaiyan == 0 && global.difficulty > 0 && global.AUG_EnemyPassthru == 0 && global.NinjaActive == 0 && instance_exists(oPlayerOvershield))
{
...
else if (enemy_dead == 0 && (global.dash_mode == 0 || oPlayerTutorial.hsp < 0) && global.GhostActive == 0 && global.player_revive_mode == 0)
{
